...
import { items } from "../../../../utils/IAPUtils";
...
const icon_play_button = require("../../drawables/play.png");
const icon_close_button = require("../../drawables/close.png");
    ...
    <>
      ...
      <Animated.View style={styles.buttonContainer}>
        ...
        >
          ...
          >
            <Animated.Image
              source={icon_close_button}
              style={[styles.icon, { tintColor: ThemeStyle.accentColor }]}
            />
          </Animated.View>
        </Touchable>
      </Animated.View>
