...
export default class Meditation extends Component{
  ...
  onChangeFunction2(newState) {
      this.setState({ switch2: newState });
  }

  onChangeFunction3(newState) {
      this.setState({ switch3: newState });
  }
    ...
    return(
      <View style={ThemeStyle.pageContainer}>
        <StatusBar
          ...
          hidden={false}
        />
        <View style={{backgroundColor:'#fff', height:54, justifyContent:'center', flexDirection:'row', alignItems:'center'}}>
          ...
          <View style={{flex:5,alignItems:'center',justifyContent:'center', }}>
              <Text style={{color:'black',textAlign:'center',fontSize:16, fontWeight:'bold',}}>Meditation</Text>
          </View>
          <View style={{flex:1}} />
        </View>
